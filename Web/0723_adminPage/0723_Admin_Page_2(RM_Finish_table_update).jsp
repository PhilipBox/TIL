                                 ...
                                 <table class="table" id="APM_table" style="width: 1200px;">
                                    <thead class="thead-light">
                                       ...
                                       <%	
                                          ...
                                          //실적관리 db로딩
                                          String sqlPM = "select * from APM_table";
                                       ...
                                       <%
                                          while (rsPM.next()) {
                                        	 String APM_id=rsPM.getString("APM_id");
                                             String APM_contDate = rsPM.getString("APM_contDate");
                                             String APM_userCode = rsPM.getString("APM_userCode");
                                             String APM_userCompany  = rsPM.getString("APM_userCompany");	
                                             String APM_userName   = rsPM.getString("APM_userName");
                                             String APM_phoneNum = rsPM.getString("APM_phoneNum");	
                                             String APM_email = rsPM.getString("APM_email");
                                             String APM_billDate = rsPM.getString("APM_billDate");
                                             String APM_calcul = rsPM.getString("APM_calcul");
                                             String APM_margin = rsPM.getString("APM_margin");
                                             
                                       %>                                       
                                       
                                       
                                       
                                          <th scope="row" width="2%"><input type="checkbox" class="APM_checkSelect" id="APM_table_index" name="APM_table_index" value=<%=APM_id%>/></th>
                                          <td width="5%"><%=APM_contDate%></td>
                                          <td width="8%"><%=APM_userCode%></td>
