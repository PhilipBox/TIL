...
<script type="text/javascript">
    ...
    function PRM_modify_btn_clicked()
    {
        ...
        var table_fee = document.getElementById("6M");
        $('#6M').attr("readonly", false);
        table_fee.style.border="1px solid #737373";
        
        var table_margin = document.getElementById("6M2");
        $('#6M2').attr("readonly", false);
	...
	function PRM_ok_btn_clicked() 
	{
            ...
            var table_fee2 = document.getElementById("6M");
            $(table_fee2).attr("readonly", true);
            table_fee2.style.border="0 solid blue";
            
            var table_margin2 = document.getElementById("6M2");
            $('6M2').attr("readonly", true);
            ...
            var new_table_index = document.getElementById("PRM_table_fee");
			alert(new_table_index.value);
			
			
			if(new_table_index.value == "1/")
				alert("일치");
			...
			<table class="table" id="PRM_table" style="width:1000px">
			  ...
			  <tbody>
			    <tr>
                                       ...
                                       <th scope="row"><input type="checkbox" id="PRM_table_index" name="PRM_table_index" value=<%=id%>/></th>
                                       <td width="5%"><%=billDate%></td>
                                       <td width="20%"><%=companyCode%></td>
                                       <td width="20%"><%=companyName%></td>
                                       <td width="15%"><%=plan%></td>
                                       <td width="15%"><%=contract%></td>
                                       <td width="15%"><INPUT type="text" name="<%=contract%>" id="<%=contract%>" size="7"  value=<%=fee%> readonly="readonly" style="border:0 solid black; text-align:center;"></td>
                                      
                                       <td width="15%"><INPUT type="text" name="<%=contract%>2" id="<%=contract%>2" size="7" value=<%=margin%> readonly="readonly" style="border:0 solid black; text-align:center;"></td>
                                       <td width="15%"><INPUT type="text" name="PRM_table_unpaid" id="PRM_table_unpaid" size="7" value=<%=unpaid%> readonly="readonly" style="border:0 solid black; text-align:center;"></td>
                                       
                                    </tr>
                                    <%
                                    	if(margin.equals("ALPHA"))
