...
<script type="text/javascript">
	...
	function phone_edit_click() {
		$("input[name='userPhone']").attr("readonly", false);
	}
...
<body class="full-height body-gray body-scroll">
	...
	<div
      ...
      <span ng-click="clickItemMenu($event, folder)">
        ...
        <span class="slide-item ng-binding" >myPage 管理</span>
      </span>
    </a>
...
<!-- 여기까지 -->
				...
				<li class="single-item ng-scope"><a class="b-menu__item-link"
					onclick="profileFunction();"><span><span
							translate="" class="ng-scope">アカウント管理</span></span></a></li>
				<li class="single-item ng-scope"><a class="b-menu__item-link"
					onclick="RMfunction();"><span><span
							translate="" class="ng-scope">販売管理</span></span></a></li>
						...
						<div class="ng-scope" id="divProfile" style="display: block">
							<table class="type04" id="myPageTable1">
								<tr>
									...
									<th scope="row">パートナーコード</th>
									<td colspan="2"><input id="userCode" name="userCode" value="<%=code%>"
										disabled></td>
								</tr>
								<tr>
									<th scope="row">企業名</th>
								...
								<tr>
									<th scope="row">お名前</th>
									<td><input id="userName" name="userName" value="<%=name%>"
										readonly></td>
									<td><button class="btn btn-default"
											onclick="name_edit_click();">修正</button> <input
								...
								<tr>
									...
									<td><button class="btn btn-default"
											onclick="phone_edit_click();">修正</button>
										<button class="btn btn-default" id="btn_phone_ok">確認</button></td>
								</tr>
								<tr>
									<th scope="row">メール</th>
							...
							<!-- TODO: 개인에선 지우기 ! 지우던가 등록 못하게 하던가 display:none-->
									<th scope="row">登記簿謄本</th>
									<td><p id="business">未登録</p></td>
									<td><button class="btn btn-default"
											id="btn_business_ok">登録</button></td>
								</tr>
								<tr>
									<th scope="row">通帳の写本</th>
									<td><p id="account" >未登録</p></td>
									<td><button class="btn btn-default"
											id="btn_account_ok">登録</button></td>
								</tr>
								<tr>
									<th scope="row" >ASDとの契約日</th>
									<td colspan="2" style="color: gray">未登録</td>
								</tr>
								<tr>
									<th scope="row">入金周期</th>
									<td colspan="2" style="color: gray">未登録</td>
								</tr>
								<tr>
									<th scope="row">請求書発送日</th>
									<td><input style="text-align: center; width: 25px;"
									id ="bill_date"
										type="text" value=" ">일/3개월</td>
									<td><button class="btn btn-default"
											id="btn_bill_ok">登録</button></td>
								</tr>
								<tr>
									<th scope="row">入金日</th>
									<td colspan="2" style="color: gray">未登録</td>
								...
								<tr>
									<th scope="row">備考</th>
									<td colspan="2" style="color: gray">未登録
								</tr>
								<%
									}
								%>
