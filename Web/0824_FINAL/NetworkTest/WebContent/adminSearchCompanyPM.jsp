			...
			<table class="table" id="APM_table" style="width: 1200px;">
				...
				<tr>
					...
					<%
						...
						//실적관리 db로딩
						String sql_susu = "select IFNULL(count(*),0) FROM partner where userCompany=?";
						pstmt_susu = conn.prepareStatement(sql_susu);
						pstmt_susu.setString(1, company);
					...
					<%
						...
						String sql = "select * from partner where userCompany=?" + " LIMIT " + curRow + ", " + countList;//"select *  FROM partner;";
						pstmt = conn.prepareStatement(sql);
					...
					<th scope="row" width="2%"><input type="checkbox"
						style="display: none;" id="userCompany" name="userCompany"
						value=<%=company%> /> <input type="checkbox"
