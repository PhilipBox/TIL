...
기존 회사명과 다를 경우 새로 등록됩니다.</textarea>
									...
									<div>
										...
										<INPUT type="text" name="APM_name" id="APM_name" size="10"
										...
										<table class="table" id="APM_table" style="width: 1200px;">
											<thead class="thead-light">
												<tr>
													...
													<th scope="col" width="15px" nowrap>마진율</th>
											...
											<tr>
												...
												<td width="10%" ><INPUT type="text" NAME="<%=APM_id%>7"
													id="<%=APM_id%>7" SIZE="1" value="<%=APM_margin%>"
													readonly="readonly" style="border: 0 solid black; text-align: center; display: inline">%</td>
												<td width="3%">
					<%
						//regiBusiness
											...
											<tbody>
												<tr>
													<%
														...
														//ARM db로딩
														String sqlARM = "select t1.c_billDate, t2.userCompany, t2.userName, t1.c_code, t1.c_name, t1.c_name, t1.c_plan, t1.c_calcul, t1.c_fee, t1.c_margin, t1.c_unpaid, t1.id FROM customer t1, partner t2 where t1.userCode = t2.userCode order by c_billDate;";
