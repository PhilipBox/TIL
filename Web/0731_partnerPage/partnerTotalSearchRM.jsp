...
<body>
	...
	<div id="divTable">
                                       ...
                                       <td width="15%"><INPUT type="text" name="<%=companyCode%>0" id="<%=companyCode%>0" size="25" value=<%=companyCode%> readonly="readonly" style="border:0 solid black; text-align:center;"></td>
