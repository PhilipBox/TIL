...
<body
 ...
 %> <a id="account" href="profileImgDown.jsp?file_name=<%=account%>"><%=account%></a>
								...
								<div id="divRM" class="ng-scope"
									...
									<textarea name=content cols="100" rows="1" id="bill_date_info0"
										...
										<div>
											<FORM method="post" name="register" id="register">
												...
												<INPUT type="text" name="PRM_userCompany" id="PRM_userCompany"
												...
												<LABEL>요금제</LABEL> <SELECT NAME="rate_system"
													...
													name="fee"	id="PRM_fee" SIZE="10"
													style="border: 2px solid #000000;"> 원&nbsp;
												<BUTTON type="button" class="btn" id="PRM_register_btn" 
													name="PRM_register_btn" onclick="register_check()" style="border: 2px solid #737373;">등록</button>
											</FORM>
...
<hr>
										...
										<div>
											...
											<form method=post id="PRM_search_period"
												...
												<LABEL>고객코드</LABEL> <INPUT type="text"
													name="customer_code" id="customer_code" size="12"
									...
									<div>
										<div style="margin : 5px">
											...
											<button style="display: inline-block; vertical-align: baseline;"
												class="btn" onclick="totalTable();">전체</button>
											<button style="vertical-align: baseline; display: inline-block;"
												...
												<tbody>
													<tr>
														...
														<th scope="row"><input type="checkbox"
															...
															name="PRM_index" value=<%=companyCode%> /></th>
														<td width="5%"><%=billDate%></td>
														<td width="15%"><INPUT type="text"
															name="<%=companyCode%>0" id="<%=companyCode%>0" size="25"
														...
														<td width="15%"><INPUT type="text"
															name="<%=companyCode%>1" id="<%=companyCode%>1" size="7"
															value=<%=fee%> readonly="readonly"
															style="border: 0 solid black; text-align: center;"></td>

														<td width="15%"><INPUT type="text"
															name="<%=companyCode%>2" id="<%=companyCode%>2" size="7"
															value=<%=margin%> readonly="readonly"
															style="border: 0 solid black; text-align: center;"></td>
														<td width="15%"><INPUT type="text"
															name="<%=companyCode%>3" id="<%=companyCode%>3" size="7"
