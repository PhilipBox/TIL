...
<script type="text/javascript">
	  ...
	  $(document).ready(function(){
 	    ...
 	    function callAjax_ARM_table_ok(){
   	        $.ajax({
   		        type: "post",
   		        url : "./test2.jsp",
   		        data: {
   		        	ajax_ARM_table_fee : $('#ARM_table_fee').val(),
   		        	ajax_ARM_table_margin : $('#ARM_table_margin').val(),
   		        	ajax_ARM_table_unpaid : $('#ARM_table_unpaid').val(),
   		        },
   		        success: whenSuccess,
   		        error: whenError
   	     	});
