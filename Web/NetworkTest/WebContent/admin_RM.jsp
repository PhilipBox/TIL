...
<script type="text/javascript">
   ...
   // ARM :  Admin Result Management
	...
	function ARM_modify_btn_clicked() 
	{
            ...
            //readonly="readonly" style="border:0 solid black;"
            ...
            // table의 요금/마진/미납금을 input창으로 활성화 시켜야함
...
6개월/1년 계약은 동일하게 선택</textarea>
		...
		&nbsp;&nbsp;<BUTTON type="button" class="btn" id="ARM_delete" name="ARM_delete" onclick="ARM_delete_btn_clicked() " style="border:2px solid #737373;">삭제</button>
			...
			<form method="post" style="display:inline">
				<LABEL>파트너코드</LABEL>
            	<INPUT type="text" name="ARM_partner_code2" id="ARM_partner_code2" size="12" style="border:2px solid #737373;">&nbsp;&nbsp;
			...
			<table class="table" id="ARM_table" style="width:1100px;">
			  ...
			  <tbody>
			    <tr>
			      ...
			      <td width="7%">프로페셔날</td>
			      <td width="8%">6개월</td>				
			      <td width="7%"><INPUT type="text" name="ARM_table_fee" id="ARM_table_fee" size="7" value="1,000,000" readonly="readonly" style="border:0 solid black;"></td>
			      <td width="5%"><INPUT type="text" name="ARM_table_margin" id="ARM_table_margin" size="7" value="900,000" readonly="readonly" style="border:0 solid black;"></td>
			      <td width="7%"><INPUT type="text" name="ARM_table_unpaid" id="ARM_table_unpaid" size="7" value="450,000" readonly="readonly" style="border:0 solid black;"></td>
			    </tr>
			    <tr>
			      <th scope="row" width="2%">1</th>
			      <td width="5%">2018/07/10</td>
