							...
							<div class="pad-t-10">
								...
								<div class="form-group">
									<label translate="" class="ng-scope">전화번호</label> <input
										type="text" name="phone_number" class="form-control input-lg ng-scope ng-pristine ng-invalid ng-invalid-required ng-valid-maxlength ng-valid-minlength ng-valid-trimming"
								...
								<div class="checkbox">
									<label> <input type="checkbox" name="user_agreement"
										...
										required="required"> 
										<span translate="" class="ng-scope">동의합니다</span> 
										<a href ng-click="showOffer()" translate="" class="ng-scope">이용약관</a>
									</label>
								</div>
								<button id="accountenroll"
									class="btn btn-lg btn-primary btn-block ng-scope" type="submit">계정 생성</button>
							</div>
						</form>
						<hr>
						<div class="row">
							<div class="col-md-12 text-center">
								<a translate="" class="ng-scope" href="./signin.jsp">이미 계정을 가지고 있습니까?</a>
							</div>
						</div>
					</div>
				</div>
...
<!-- compiled CSS -->
<script src="./assets/ng-cloudike-2.3.1-1.css"></script>
</body>
</html>