...
<body>
	...
	//2는 sum
		...
		System.out.println("고객코드 : " +customer_code);
								...
								<div id="pagination" style="text-align: center">
											...
											System.out.println("		최종데이터 검사 : 유저코드/날짜/고객이름,코드 : " + userCode+" / "+startDate+"~"+endDate+" / "+customer_code+" / "+customer_name);
												if (curPageC > 1) {
													...
													out.print("<button type='button' onclick='readPagingSearchRM(" + 1 + ", " + countListC + ","+startDate2+ "," + endDate2 +"," + customer_code2+","+ customer_name2+");' class='btn btn-default'><<</button>");
													//		out.print("<a href=\"?scurPage_partenr=" + 1 + "\">처음</a>");
													//out.print("<a href=\"?curPage=" + (curPage - 1) + "\">< 이전</a>");
													out.print("<button type='button' onclick='readPagingSearchRM(" + (curPageC - 1) + ", " + countListC + ","+startDate2+ "," + endDate2 +"," + customer_code2+","+ customer_name2+");' class='btn btn-default'><</button>");
												...
												for (int i = startPageC; i < endPageC + 1; i++) { 	// i 는 현재 페이지의 번호
													...
													out.print("<button type='button' onclick='readPagingSearchRM(" + i + ", " + countListC + ","+startDate2+ "," + endDate2 +"," + customer_code2+","+ customer_name2+");' class='btn btn-default'>" + i + "</button>");
												}
												if (curPageC < totalPageC) {
													...
													out.print("<button type='button' onclick='readPagingSearchRM(" + totalPageC + ", " + countListC + ","+startDate2+ "," + endDate2 +"," + customer_code2+","+ customer_name2+");' class='btn btn-default'>>></button>");
