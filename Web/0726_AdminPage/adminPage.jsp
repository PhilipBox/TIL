...
6개월/1년 계약은 동일하게 선택</textarea>
        ...
        <!--  TABLE 상단 : 검색 AREA  -->
        <div>
        	<button id="currentMonth"  class="btn" name="currentMonth" onclick="currentMonthFunction();"> 이번달</button>
				<button id="preMonth" name="preMonth"  class="btn" onclick="preMonthFunction();"> 지난달</button>
        ...
        <!-- TODO :  수정 확인버튼 -->
         ...
         <FORM method="post" name="ARM_btn_event" id="ARM_btn_event" style="display:inline">
			...
			<form  method=post name="ARM_search_per	iod" id="ARM_search_period" style="display:inline">
				...
				<LABEL>파트너코드</LABEL>
            	<INPUT type="text" name="partner_code" id="partner_code" size="12" style="border:2px solid #737373;">&nbsp;&nbsp;

				<LABEL>고객코드</LABEL>
            	<INPUT type="text" name="customer_code" id="customer_code" size="12" style="border:2px solid #737373;">&nbsp;&nbsp;            	
            <BUTTON type="button" class="btn" id="ARM_search_btn" onclick="searchBtn();"
						name="ARM_search_btn" style="border: 2px solid #737373;">검색</button>
				</form>
