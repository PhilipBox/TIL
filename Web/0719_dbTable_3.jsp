...
<script type="text/javascript">
    ...
    function PRM_modify_btn_clicked()
    {
        ...
        */
    	...
    	var checked = "";
		$('#PRM_table_index:checked').each(function(){
			checked = $(this).val();
			
			// id뒤에 이유모를 '/'가 붙어서 지워주는 코드를 추가하였당
        ...
        for (var i=1; i<=3; i++) {
        		...
        		//alert(i+testing);
        		var table_fee = document.getElementById(i+testing);
        ...
        /*
        var table_fee = document.getElementById(test);
        $(table_fee).attr("readonly", false);
        table_fee.style.border="1px solid #737373";
        */
        ...
        var table_margin = document.getElementById("3a2");
        $('#3a2').attr("readonly", false);
        table_margin.style.border="1px solid #737373";
        
        var table_unpaid = document.getElementById("3a3");
        $('#3a3').attr("readonly", false);
	...
	function PRM_ok_btn_clicked() 
	{
	        ...
	        for (var i=1; i<=3; i++) {
	        		...
	        		var table_fee = document.getElementById(checked+i);
	        ...
	        for (var i=1; i<=3; i++) {
	        		test2 = "2a"	;
	        		test2 = "2a"+ i;
	        		var table_fee = document.getElementById(test2);
	                $(table_fee).attr("readonly", true);
	                table_fee.style.border="0 solid blue";
	        	}

	        	        
	        var table_fee2 = document.getElementById("3a1");
	        $(table_fee2).attr("readonly", true);
            table_fee2.style.border="0 solid blue";
	        
            var table_margin2 = document.getElementById("3a2");
            $(table_margin2).attr("readonly", true);
            table_margin2.style.border="0 solid blue";
            
            var table_unpaid2 = document.getElementById("3a3");
