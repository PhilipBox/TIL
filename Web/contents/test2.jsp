...
<!-- ARM ajax -->
		...
		<% 
		String ajax_ARM_table_c_code = request.getParameter("ajax_ARM_table_c_code");
		String ajax_ARM_table_fee = request.getParameter("ajax_ARM_table_fee");
		String ajax_ARM_table_margin = request.getParameter("ajax_ARM_table_margin");
		String ajax_ARM_table_unpaid = request.getParameter("ajax_ARM_table_unpaid");
		%>
		...
		System.out.println("■■■■■■■ Admin Result Page ■■■■■■■");
			...
			System.out.println("[ARM 테이블 정보] " + ajax_ARM_table_fee +" "+ ajax_ARM_table_margin +" "+ajax_ARM_table_unpaid);
			System.out.println("[PRIMARY KEY - 고객 코드] " + ajax_ARM_table_c_code);
		%>
