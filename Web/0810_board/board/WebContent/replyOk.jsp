...
response.setCharacterEncoding("UTF-8");
	...
	try {
		...
		sql = "UPDATE board SET step=step+1 where userCode=\""+ code+"\" and ref="+ref+" and step>" +step;
		stmt.executeUpdate(sql);
		
		sql = "INSERT INTO board(userName, title, memo, ref, indent, step, fromAdmin, userCode) "+
				"values(?,?,?,?,?,?,?,?)";
