...
<div class="ng-scope" id="divRegister" style="margin-top: 20px; margin-left: 20px; display:none;">

									<div id="flipRegisterPTN">
										<h3 style="color: #428BCA; display: inline">파트너사 등록 ▼ <SCRIPT type="text/javascript">spacing(150);</SCRIPT> </h3>
									</div>
...
기존 회사명과 다를 경우 새로 등록됩니다.</textarea>
									...
									<div id="flipRegisterCUS">
										<h3 style="color: #428BCA; display: inline">고객사 등록 ▼ <SCRIPT type="text/javascript">spacing(150);</SCRIPT></h3>
									...
									<div id="flipContentRegisterCUS" style="display: block;">
										...
										<div>
											...
											<br>
												&nbsp;<LABEL>계산서발행일ㅋ</LABEL> <INPUT type="text"
