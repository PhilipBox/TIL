...
<%
     ...
     System.out.println("경로:"+saveDirectory +"<br>");
     ...
     while(formNames.hasMoreElements()) {
          ...
          if (fileName != null) {
               ...
               if(!(fileExtend.equalsIgnoreCase("jpg") || fileExtend.equalsIgnoreCase("gif") || fileExtend.equalsIgnoreCase("png")||fileExtend.equalsIgnoreCase("pdf"))){
	...
	// response.sendRedirect("partnerPage.jsp"); //   location.href="boardList.jsp";  response.sendRedirect("login.jsp?url="+url);
	 response.sendRedirect("partnerPage.jsp?flag="+1);
