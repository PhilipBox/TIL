								...
								<div>
									<div>
										...
										<BUTTON type="button" class="btn" id="APM_delete"
											...
											style="vertical-align: baseline;">삭제</button>
										<SCRIPT type="text/javascript">
													spacing(3);
												</SCRIPT>
										<button
								...
								<div style="margin-top: 20px; margin-left: 20px;">
									...
									<div id="divTable">
										<div style="margin: 5px">
											...
											<button style="display: none; vertical-align: baseline;"
											...
											<tbody>
												<tr>
													...
													<%
														...
														String sqlARM = "select t1.id, t1.c_billDate, t2.userCompany, t2.userName, t1.c_code, t1.c_name, t1.c_name, t1.c_plan, t1.c_calcul, t1.c_fee, t1.c_margin, t2. margin, t1.c_unpaid FROM customer t1, partner t2 where t1.userCode = t2.userCode order by c_billDate"
													...
													<%
														...
														if (totalPageC < curPageC) {
															curPageC = totalPageC;
															// 전체페이지 수가 현재페이지 수보다 작으면  - 현재페이지를 전체페이지 수로 한다.
														}
														...
														// 끝나는페이지 : 시작페이지 + 페이지 수  -1 

														
														if (endPageC > totalPageC)
															endPageC = totalPageC;
														// 끝나는페이지가 전체페이지보다 더 크면 - 끝나는 페이지를 전체 페이지로 한다.
													%>
								...
								<div id="flipContentRegisterPTN" style="display: block;">
									<div>
										<FORM method="post" name="PTNregister" id="PTNregister">
											<br> &nbsp;<LABEL>계약시작일</LABEL> <INPUT type="text"
								...
								<div id="flipContentRegisterCUS" style="display: block;">
									...
									<div>
										<FORM method="post" name="ARM_register" id="ARM_register">
											<br> &nbsp;<LABEL>계산서발행일</LABEL> <INPUT type="text"
