...
<%
	...
	*/
	...
	//customer table data 
	String c_id = request.getParameter("ajax_APM_table_c_id");
	...
	customerFee = customerFee.replaceAll(",","");
	customerMargin = customerMargin.replaceAll(",","");
	customerUnpaid = customerUnpaid.replaceAll(",","");
	
	
	
	c_id = c_id.replaceAll("/", "");
	c_id = c_id.replaceAll("PRM", "");
	c_id = c_id.replaceAll("_", "");
