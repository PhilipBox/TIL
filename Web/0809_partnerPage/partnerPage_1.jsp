...
<script type="text/javascript">
	...
	function callAjax_PRM_table_ok(c_id, c_code, fee, margin, unpaid) {
		$.ajax({
			type : "post",
			//url : "./partnerRMSet.jsp",
			url : "adminModifyNoti.jsp",
			data : {
				ajax_APM_table_c_id : $(c_id).val(),
...
<script type="text/javascript">
	...
	function ChangeInputState_for_register(PRM_table_id) {
		...
		var c_id = document.getElementById(PRM_table_id);
		...
		//Id값을 담은 객체를 보내줘야해!
		callAjax_PRM_table_ok(c_id, c_code, table_fee, table_margin, table_unpaid);
										...
										<div>
											...
											<FORM method="post" name="PRM_btn_event" id="PRM_btn_event"
												...
												<BUTTON type="button" class="btn" id="PRM_modify"
													...
													style="border: 2px solid #737373; display:none;">수정</button>
												...
												<BUTTON type="button" class="btn" id="PRM_delete"
													...
													style="border: 2px solid #737373; display:none;">삭제</button>
											</FORM>
