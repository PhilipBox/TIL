...
%>
	...
	<input type=button value="답글" class="btn btn-default" onclick="locationReply(<%=idx%>);">
	<input type=button value="목록" class="btn btn-default" OnClick="window.location='boardList.jsp'">
	<input type=button value="수정" class="btn btn-default" OnClick="locationModify(<%=idx%>);">
