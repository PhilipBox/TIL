...
<script>
	...
	function emailCheck() {
		...
		if (isEmpty(userEmail)) {
			$('#emailEnterMessage').css("display", "none");
			$('#email').css("border-color", "red");
			return false;
		} else if (!(regEmail.test(userEmail))) {
			$('#emailEnterMessage').css("display", "block");
			$('#email').css("border-color", "red");
			return false;
		} else {
			$('#emailEnterMessage').css("display", "none");
	...
	function passwordCheck() {
	      ...
	      if (userPassword.length > 0 && userPassword.length < 6) {
	         ...
	         $('#password').css("border-color", "red");
	         return false;
	      } else if (userPassword.length >= 6 && userPassword.length <= 32) {
	         $('#passwordMaxLengthMessage').css("display", "none");
	         $('#passwordMinLengthMessage').css("display", "none");
...
<body
	...
	<!-- uiView: layout -->
	<div
		class="continer-fluid g-layout g-layout__layout full-height ng-scope">
		<div class="row full-height ng-scope">
			...
			<div id="KFrame" style="display: block"
				...
				<div class="row oauth-form ng-scope company-domain">
					<div class="well well-lg col-md-6 col-md-offset-3 sexy-well">
						...
						<hr>
						<div class="pad-t-10">
							<form name="forEmail" method="post" action="userSigninAction.jsp"
								...
								<div class="form-group">
									...
									<!--  -->
									<div id="emailEnterMessage" class="popover bottom fade in"
										title="" style="top: 278.8px; left: 66.5px; display: none;">
										<div class="arrow"></div>
										<div class="popover-inner">
											<div class="popover-content ng-binding">이메일 주소를 입력하세요</div>
										</div>
									</div>
									<!--  -->
								</div>
								<div class="form-group">
									...
									<div id="passwordMinLengthMessage"
										...
										style="top: 362.8px; left: 66.5px; display: none;">
										<div class="arrow"></div>
										<div class="popover-inner">
									...
									<div id="passwordMaxLengthMessage"
										class="popover bottom fade in" title=""
										style="top: 362.8px; left: 45.5px; display: none;">
										<div class="arrow"></div>
										<div class="popover-inner">
								...
								<button class="btn btn-lg btn-primary btn-block ng-scope"
									type="submit" onclick="profilePage()">로그인</button>
							</form>
							<div class="hg-hide">
							...
							<div class="row">
								<div class="col-xs-6 text-left ng-scopecol-xs-offset-6">
									<a class="ng-scope" href="./userJoin.jsp">회원등록</a>
								</div>
								<div class="col-xs-6 text-right ng-scopecol-xs-offset-6">
									<a class="ng-scope" href="./userResetpassword.jsp">비밀번호를<br>
										잊으셨나요?
									</a>
								</div>
							</div>
			...
			<!-- uiView: hidden main (ver.jap) -->
			<div id="JFrame" style="display: none"
				class="col-md-8 col-md-offset-2 full-height layout-col-pad ng-scope">
				<div class="row oauth-form ng-scope company-domain">
					<div class="well well-lg col-md-6 col-md-offset-3 sexy-well">
						<h3 class="text-center break-word ng-scope"
						...
						<div class="pad-t-10">
							<form name="forEmail"
								class="ng-invalid ng-invalid-required ng-pristine ng-invalid-last-attempt">
								<div class="form-group">
									<label class="ng-scope">メールアドレス</label> <input type="email"
										name="email"
										class="form-control input-lg ng-scope ng-invalid ng-invalid-required ng-valid-maxlength ng-valid-email ng-animate ng-dirty-remove ng-dirty-remove-active ng-pristine"
								...
								<div class="form-group">
									<label class="ng-scope">パスワード</label> <input type="password"
										name="password"
										class="form-control input-lg ng-scope ng-invalid ng-invalid-required ng-valid-maxlength ng-animate ng-dirty-remove ng-dirty-remove-active ng-pristine"
								...
								<div class="form-group has-error"></div>
								<button class="btn btn-lg btn-primary btn-block ng-scope"
									type="submit" onclick="profilePage()">ログイン</button>
							</form>
							<div class="hg-hide">
								<!-- 버튼 하이드 <button class="btn btn-lg btn"></button> -->
							</div>
							...
							<div class="form-group text-left">
								<span class="ng-scope"> <label class="ng-scope">지역</label>
									...
									<option class="ng-scope" value="1">한국</option>
									<option class="ng-scope" value="2" selected="selected">日本</option>
								</select>
							</div>
							<div class="row">
								<div class="col-xs-6 text-left ng-scopecol-xs-offset-6">
									<a class="ng-scope" href="./userJoin.jsp">アカウント登録</a>
								</div>
								<div class="col-xs-6 text-right ng-scopecol-xs-offset-6">
									<a class="ng-scope" href="./userResetpassword.jsp">パスワードを<br>
										お忘れですか？
									</a>
								</div>
							</div>
