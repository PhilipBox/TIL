...
<body>
	...
	String sql2;
		...
		if(menu == 1){
			//feeSortD
			 sqlRM = "select * from CUSTOMER where userCode=? order by c_fee+0 desc LIMIT " + curRowC + ", " + countListC;
			
			sql_susuC = "select count(*) from customer where userCode=\"" + userCode +"\" order by c_fee+0";
			...
			rs_susuC.next();
			 ...
			 sqlRM = "select * from CUSTOMER where userCode=? order by c_fee+0 asc LIMIT " + curRowC + ", " + countListC;
			...
			rs_susuC.next();
			 ...
			 sqlRM = "select * from CUSTOMER where userCode=? order by c_plan desc LIMIT " + curRowC + ", " + countListC;
			 
			sql_susuC = "select count(*) from customer where userCode=\"" + userCode +"\" order by c_plan";
			stmt_susuC.executeQuery(sql_susuC);
			ResultSet rs_susuC = null;
			rs_susuC = stmt_susuC.executeQuery(sql_susuC);
			rs_susuC.next();
			 ...
			 sqlRM = "select * from CUSTOMER where userCode=? order by c_plan asc LIMIT " + curRowC + ", " + countListC;
			...
			rs_susuC.next();		
			 ...
			 sqlRM = "select * from CUSTOMER where userCode=? order by c_margin+0 desc LIMIT " + curRowC + ", " + countListC;
		
			sql_susuC = "select count(*) from customer where userCode=\"" + userCode +"\" order by c_margin+0";
			stmt_susuC.executeQuery(sql_susuC);
			ResultSet rs_susuC = null;
			rs_susuC = stmt_susuC.executeQuery(sql_susuC);
			rs_susuC.next();
			 ...
			 sqlRM = "select * from CUSTOMER where userCode=? order by c_margin+0 asc LIMIT " + curRowC + ", " + countListC;
