...
<script>
	...
	function writeCheck() {
		...
		var notice = 0;
		if ($("#noticeCheck option:selected").val() == "공지") {
			writeNotice();
					...
					<tr>
						...
						<td colspan="1" align="center"><select
							style="width: 90px; height: 30px" id="noticeCheck">
								<option class="ng ng-scope" value="공지">공지</option>
								<option class="ng ng-scope" value="안내">안내</option>
						</select></td>
					</tr>

					<tr>
						<td style="text-align: center; padding: 150px 60px 150px 60px;"
							colspan="1">내용</td>
						<td colspan="5"><textarea name="memo" id="memo"
								class="nse_content"></textarea> <script type="text/javascript">
									var oEditors = [];
									nhn.husky.EZCreator
											.createInIFrame({
												oAppRef : oEditors,
