...
function readPagingRM(curPage, countList) {
	alert("partner_readPagingRM"+curPage+" / "+countList);
	$.ajax({
		type : "post",
...
function readPagingSearchRM(curPage, countList, startDate2, endDate2, customer_code, customer_name) {
	alert("◆"+curPage+" / " + countList+ "// " + startDate2 + " ~ " + endDate2+" [고객코드]" + customer_code + "//[고객이름]" + customer_name + "◆");
...
/*
 function testCall(curPage, countList, userCode, startDate, endDate, customer_code, customer_name){
	alert(curPage +" / " + countList +" / " + userCode +" / ㅁ" + startDate +"~" + endDate +"ㅁ / " + customer_code +" / " + customer_name);
								...
								<div id="divRM" class="ng-scope"
									...
									<div id="flipContent" style="display: none;">
										...
										<div style=" margin:10px">
											<div id="feeSort" style="vertical-align: baseline; display: inline-block;">
												<button
													style="vertical-align: baseline; display: inline-block;"
													id="feeSortD" name="feeSortD" class="btn" onclick="sortEach(1)">요금별▼</button>
												<button
													style="vertical-align: baseline; display: inline-block;"
													id="feeSortA" name="feeSortA" class="btn" onclick="sortEach(2)">요금별▲</button>
											</div>
											<div id="planSort" style="vertical-align: baseline; display: inline-block; margin-left:18px">
												<button
													style="vertical-align: baseline; display: inline-block;"
													id="planSortD" name="planSortD" class="btn" onclick="sortEach(3)">요금제별▼</button>
												<button
													style="vertical-align: baseline; display: inline-block;"
													id="planSortA" name="planSortA" class="btn" onclick="sortEach(4)">요금제별▲</button>
											</div>
											<div id="marginSort" style="vertical-align: baseline; display: inline-block; margin-left:18px" >
												<button
													style="vertical-align: baseline; display: inline-block;"
													id="marginSortD" name="marginSortD" class="btn" onclick="sortEach(5)">마진별▼</button>
												<button
													style="vertical-align: baseline; display: inline-block;"
													id="marginSortA" name="marginSortA" class="btn" onclick="sortEach(6)">마진별▲</button>
											</div>
										...
										<div id="divTable">
											<table class="table" id="PRM_table" style="width: 1000px">
												...
												<tbody>
													...
													//실적관리 db로딩
													String sql_susuC = "select count(*) FROM customer_lis where userCode = \"" + userCodeInitRM +"\"";
