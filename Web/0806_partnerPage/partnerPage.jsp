...
<script type="text/javascript">
	...
	function callAjax_PRM_table_delete(PRM_id) {
		$.ajax({
			type : "post",
			url : "./partnerRMDelete.jsp",
			data : {
				ajax_PRM_table_id_for_delete : $(PRM_id).val(),
			},
			success : whenSuccess,
			error : whenError
		});
...
<script type="text/javascript">
	...
	function PRM_Delete_table_col(PRM_table_id) {
		var c_code = document.getElementById(PRM_table_id)

		callAjax_PRM_table_delete(c_code);	
	}
												...
												<tbody>
													<tr>
														...
														<th scope="row"><input type="checkbox"
															class="PRM_checkSelect" id="<%=PRM_id%>"
															name="PRM_index" value=<%=PRM_id%> /></th>
